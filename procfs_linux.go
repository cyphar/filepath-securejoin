...
var hasNewMountAPI = gocompat.SyncOnceValue(func() bool {
	...
	isNotBackport, _ := kernelversion.GreaterEqualThan(kernelversion.KernelVersion{5, 2}) //nolint:govet // KernelVersion is from an internal package and is meant to be used without qualified field names
